...
public class ElementosWebDBanckRegistrarFinanciacion {
    ...
    public static final Target loan=Target.the("select emploment").located(By.id("monthlyAutoLoan"));
    public static final Target otherloan=Target.the("select emploment").located(By.id("monthlyOtherLoan"));
    public static final Target creditcard=Target.the("select emploment").located(By.id("minimumCreditCard"));
    public static final Target cardspend=Target.the("select emploment").located(By.id("monthlySpend"));
    public static final Target havebank=Target.the("select emploment").located(By.id("bankStatus"));
    public static final Target check1=Target.the("select emploment").located(By.xpath("//input[@id='agreeTerms']"));
    public static final Target aply=Target.the("select emploment").located(By.xpath("//button[@class='btn btn-success btn-lg btn-block']"));
   public static  final Target verificar=Target.the("select emploment").located(By.xpath("//p[contains(text(),'Thank you for your interest in a Digital Credit ac')]"));
}
